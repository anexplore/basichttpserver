...
/**
 * http constant copy and merge from httpcore
 * 
 * @author caoly
 *
 */
public final class HttpConstant {
	...
	public static final Charset DEF_CONTENT_CHARSET = Charset.forName("UTF-8");
	public static final Charset DEF_PROTOCOL_CHARSET = Charset.forName("ASCII");
